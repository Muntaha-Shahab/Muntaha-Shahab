...
Command-line task manager with persistent storage. Handles add, update, complete, and delete operations. Simple scope built to practice clean Python architecture and proper separation of concerns.
